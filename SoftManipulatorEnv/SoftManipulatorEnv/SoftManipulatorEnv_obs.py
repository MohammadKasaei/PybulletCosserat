...
class SoftManipulatorEnv(gym.Env):
    def __init__(self,gui=True) -> None:
        ...
        self.obj_id = self._env.add_a_cube(self._initial_pos, [0.4,0.02,0.02],  mass=0,color=[0.8,0.8,0,0])
    ...
    def reset(self):
        ...
        des_z  = np.random.uniform(low= 0.15, high=0.35, size=(1,))
...
if __name__ =="__main__":
    ...
    # model = SAC.load("logs/learnedPolicies/model_20240605-184526", env = sf_env)
